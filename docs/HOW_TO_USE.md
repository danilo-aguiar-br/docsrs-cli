...
- Confirm `data.version` from `docsrs-cli version --json` is `1.1.0` on the 1.1 line
...
## Other Subcommands
- `version` prints binary identity (`1.1.0` on this line)
...
- Read [MIGRATION.md](MIGRATION.md) when upgrading from 0.1.x
