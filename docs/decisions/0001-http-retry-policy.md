...
- Never retry permanent `4xx`, parse errors, body cap (`ErrorKind::Budget`, exit 74, `retryable=false`), or cancel
...
- Kill switch documentation stays aligned with 0.1.x flags + TOML config
